...
{
	//ワールド行列.
	D3DXMATRIX mWorld, mScale, mRot, mPre;
	...
	//準備位置.
	D3DXMatrixTranslation(&mPre, m_vPrePos.x, m_vPrePos.y, m_vPrePos.z);
	...
	mWorld = mPre * mScale * mRot * mWorld;
			...
			0, D3D11_MAP_WRITE_DISCARD, 0, &pData)))
	{
		...
		D3DXVECTOR4 vColor = D3DXVECTOR4(m_vColor.x, m_vColor.y, m_vColor.z, m_Alpha);
		cb.vColor = vColor;
