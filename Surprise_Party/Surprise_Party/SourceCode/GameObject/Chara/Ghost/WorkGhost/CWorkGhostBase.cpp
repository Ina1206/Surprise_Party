...
//		行動選択描画処理関数.
//=========================================.
void CWorkGhostBase::SelectRender()
{
...
//		体力アイコン描画処理関数.
//=========================================.
void CWorkGhostBase::StrengthIconRender()
{
	//休憩時以外表示する.
...
//		驚かす行動を決める処理関数.
//==========================================.
HRESULT CWorkGhostBase::SurpriseActDecide()
{
	//驚かし休憩処理.
...
//		驚かす当たり判定処理関数.
//==========================================.
HRESULT CWorkGhostBase::SurpriseHit()
{
...
//		選択後の行動処理関数.
//==========================================.
void CWorkGhostBase::SelectAfterActivity()
{
...
//		ギミック移動処理関数.
//===========================================.
void CWorkGhostBase::MoveGimmick()
{
...
//		デバッグ用球体描画処理関数.
//=============================================.
void CWorkGhostBase::DebugHitSphereRender()
{
#ifdef _DEBUG
...
//		休憩移動処理関数.
//===========================================.
void CWorkGhostBase::RestMove(float* pfVar, float fSpeed, float fMax)
{
	*pfVar += fSpeed;
	if (*pfVar >= fMax) {
		*pfVar = fMax;
...
//		回復処理関数.
//===========================================.
void CWorkGhostBase::Resurrection(float* pfVar, float fSpeed, float fMin)
{
	*pfVar -= fSpeed;
	if (*pfVar <= fMin) {
		*pfVar = fMin;
...
//		移動速度変更処理関数.
//============================================.
void CWorkGhostBase::MoveSpeedChange()
{
...
//		移動更新処理関数.
//============================================.
void CWorkGhostBase::MovePosReference()
{
	//驚かしているとき以外場所更新.
	if (!(m_SurpriseFlag & SURPRISE_ACT_FLAG) &&
