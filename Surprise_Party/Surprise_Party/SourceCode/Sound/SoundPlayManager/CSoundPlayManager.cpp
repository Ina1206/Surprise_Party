#include "CSoundPlayManager.h"

/**************************************
*		サウンド再生管理クラス.
**/
CSoundPlayManager::CSoundPlayManager()
...
//		初期化処理関数.
//=======================================.
HRESULT CSoundPlayManager::Init(HWND hWnd)
{
	//サウンド読み込みクラス.
	...
	for (int sound = 0; sound < LOOP_SE_MAX; sound++) {
		m_ppCLoopSound[sound] = m_pCSoundResource->GetBGM(sound);
	}
...
//		解放処理関数.
//========================================.
HRESULT CSoundPlayManager::Release()
{
	//配列解放.
