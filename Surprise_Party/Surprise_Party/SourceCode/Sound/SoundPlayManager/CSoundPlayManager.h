...
public:
	...
	const int LOOP_SE_MAX			= static_cast<int>(CSoundResource::enBGM::Max);			//ループ音の最大数.
	...
	//LoopSE再生フラグ.
	void SetLoopSEPlay(CSoundResource::enBGM LoopSE, bool flag) { m_pbPlayLoopSE[static_cast<int>(LoopSE)] = flag;}
	//音量置換処理関数.
